package com.pixys.android.systemui.keyguard;
...
public class PixysKeyguardSliceProvider extends KeyguardSliceProvider implements SmartSpaceUpdateListener {
    ...
    public Slice onBindSlice(Uri uri) {
        ...
        Trace.beginSection("PixysKeyguardSliceProvider#onBindSlice");
    ...
    private static class AddShadowTask extends AsyncTask<Bitmap, Void, Bitmap> {
        ...
        private final WeakReference<PixysKeyguardSliceProvider> mProviderReference;
        private final SmartSpaceCard mWeatherCard;

        AddShadowTask(PixysKeyguardSliceProvider pixysKeyguardSliceProvider, SmartSpaceCard smartSpaceCard) {
            this.mProviderReference = new WeakReference<>(pixysKeyguardSliceProvider);
            this.mWeatherCard = smartSpaceCard;
            this.mBlurRadius = pixysKeyguardSliceProvider.getContext().getResources().getDimension(R.dimen.smartspace_icon_shadow);
        }
        ...
        public void onPostExecute(Bitmap bitmap) {
            PixysKeyguardSliceProvider pixysKeyguardSliceProvider;
            synchronized (this) {
                this.mWeatherCard.setIcon(bitmap);
                pixysKeyguardSliceProvider = this.mProviderReference.get();
            }
            if (pixysKeyguardSliceProvider != null) {
                pixysKeyguardSliceProvider.notifyChange();
            }
        }
