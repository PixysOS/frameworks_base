...
public class LiveWallpaperScrimController extends ScrimController {
    ...
    public LiveWallpaperScrimController(ScrimView scrimView, ScrimView scrimView2, ScrimView scrimView3, LockscreenWallpaper lockscreenWallpaper, TriConsumer<ScrimState, Float, GradientColors> triConsumer, Consumer<Integer> consumer, DozeParameters dozeParameters, AlarmManager alarmManager, KeyguardMonitor keyguardMonitor) {
        super(scrimView, scrimView2, scrimView3, triConsumer, consumer, dozeParameters, alarmManager, keyguardMonitor);
