...
public class WeatherClient {
    ...
    public static final String SERVICE_PACKAGE = "com.pixys.weather.client";
    private static final String SERVICE_PACKAGE_PERMISSION = SERVICE_PACKAGE + ".READ_WEATHER";
    public static final Uri WEATHER_URI = Uri.parse("content://com.pixys.weather.client.provider/weather");
